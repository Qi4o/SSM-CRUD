...
<script type="text/javascript">
    ...
    function validate_add_form(){
        ...
        if(!regName.test(empName)){
            // alert("用户名可以是2-5位的中午或6-16位英文和数字的组合");
            show_validate_msg("#empName_add_input", "error", "用户名可以是2-5位的中午或6-16位英文和数字的组合");
            return false;
        } else {
    ...
    $("#check_all").click(function (){
        ...
        //dom原生属性，attr获取自定义属性，prop修改和读取dom原生属性的值
